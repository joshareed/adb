...
<html>
	...
	<body>
		<div class="nav">
			...
			<span class="menuButton"><g:link class="citation-add" action="create"><g:message code="default.new.label" args="[entityName]" /></g:link></span>
		</div>
		<div class="body">
			...
			<g:form method="post" >
				...
				<g:hiddenField name="version" value="${citationInstance?.version}" />
				<div class="dialog">
					<table>
						<tbody>
							<tr class="prop">
