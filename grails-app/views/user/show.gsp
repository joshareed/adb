			...
			<div class="dialog">
				<table>
					<tbody>
						...
						<tr class="prop">
							<td valign="top" class="name"><g:message code="user.institution.label" default="Institution" /></td>
						...
						<tr class="prop">
							<td valign="top" class="name"><g:message code="user.postalCode.label" default="Postal Code" /></td>
							<td valign="top" class="value">${fieldValue(bean: userInstance, field: "postalCode")}</td>
						</tr>
						<tr class="prop">
